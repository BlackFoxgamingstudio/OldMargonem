...
<div style='display: none; top: 0px; left: 0px;' class='ctip tip_item' id=oTip_item torba1><b>Torba Podró¿nika</b>Typ: Torby<br>Mieœci 42 przedmioty<br>Wartosc: 0</div>
";
...
if($postac['poziom'] >= $dane['wym_poziom']) $ajax_txt .= "<b class=att>Wymagany poziom: ".
$dane['wym_poziom']."</b>";
else $ajax_txt .= "<b class=att2>Wymagany poziom: ".
$dane['wym_poziom']."</b>";
}
$ajax_txt .= "<br>Wartosc: ".
$dane['wartosc_sprzedazy']."</div>
